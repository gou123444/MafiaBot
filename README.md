...
```sh
git clone https://github.com/gou123444/MAFIA-USERBOT.git
cd MAFIA-USERBOT
...
Poject [MAFIABOT](https://github.com/gou123444/MafiaBotOP) is free software: you can redistribute it and/or modify
